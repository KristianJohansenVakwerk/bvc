...
const ContactSection = (props: Props) => {
  ...
  return (
    <Section className="w-full border-l-[0.5px] border-r-[0.5px] border-t-[0.5px] border-black flex flex-col md:flex-row md:flex-wrap justify-center items-start gap-0">
